...
export default function LiteratureListItem({
  ...
  return (
    <div className="rounded-lg border theme-bg-card theme-border-primary hover:theme-border-secondary transition-colors overflow-hidden">
      ...
      <div
        onClick={onSelect}
        className="group flex items-center gap-3 px-4 py-3 hover:theme-bg-hover transition-colors cursor-pointer"
      >
        {/* Left color strip */}
        <div
        ...
        <button
          ...
          className="min-w-0 flex-1 truncate font-body text-sm font-medium theme-text-primary hover:text-gold-500 transition-colors text-left"
        >
